                ...
                <div class="flex flex-wrap">
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" class="w-full bg-gray-100 bg-opacity-50 
                            ...
                            transition-colors duration-200 ease-in-out" value="{{old('name')}}">
                        </div>
                        @error('name')
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="text" id="price" name="price"
                                   ...
                                   duration-200 ease-in-out" value="{{old('price')}}"/>
                        </div>
                        @error('price')
                            <div class="text-red-400 text-sm">{{$message}}</div>
                        @enderror
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="text" id="stock" name="stock"
                                   ...
                                   focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 
                                   text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors 
                                   duration-200 ease-in-out" value="{{old('stock')}}">
                        </div>
                        @error('stock')
                            <div class="text-red-400 text-sm">{{$message}}</div>
                        @enderror
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <textarea
                                ...
                                focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 
                                text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors 
                                duration-200 ease-in-out">{{old('description')}}</textarea>
                        </div>
                    </div>

                    <div class="p-2 w-full">
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none 
                        hover:bg-indigo-600 rounded" type="submit">Adicionar</button>
                    </div>
